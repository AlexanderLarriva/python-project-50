...
plain_expected_output = read_file(
    get_fixture_path("expected_output_plain.txt")).split("---")
json_expected_output = read_file(
    get_fixture_path("expected_output_json.txt")).split("---")
stylish_expected_output = read_file(
    get_fixture_path("expected_output_stylish.txt")).split("---")
